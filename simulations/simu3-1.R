...
est1 <- simu(simuno=200,seedn=100,toI=20,n=30,true.beta=c(1,-5),true.a=2,tt=0.02,rr=0.5)
save(est1, file = "en1.RData")
est2 <- simu(simuno=200,seedn=101,toI=20,n=40,true.beta=c(1,-5),true.a=2,tt=0.02,rr=0.5)
